...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-teal-900 to-teal-900 text-white">
      {/* Pre Footer CTA */}
      <div className="bg-gradient-to-r from-teal-700 to-teal-500 gradient-shift bg-[length:200%_200%]">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Branches Column */}
          <AnimateOnScroll animation="up" delay={200}>
            <div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/60 text-sm text-center md:text-left">
              © 2024 Memorial Hospital. Bütün hüquqlar qorunur.
            </p>
            <div className="flex items-center gap-4 text-sm text-white/60">
              <Link href="/siyasət" className="hover:text-white transition-colors duration-200">
                Məxfilik Siyasəti
              </Link>
              <span>|</span>
              <Link href="/şərtlər" className="hover:text-white transition-colors duration-200">
                İstifadə Şərtləri
              </Link>
            </div>
            <button
