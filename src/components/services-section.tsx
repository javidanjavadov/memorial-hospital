      ...
      <div className="container mx-auto px-4">
        ...
        <StaggerContainer>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              <Card
                key={service.id}
                className="group border-0 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden opacity-0 translate-y-4 hover:-translate-y-1"
              >
        ...
        <StaggerContainer>
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-start gap-4 opacity-0 translate-y-4 transition-all duration-500 hover:-translate-y-0.5">
